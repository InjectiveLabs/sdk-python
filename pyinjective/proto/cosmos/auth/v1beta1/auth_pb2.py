...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_BASEACCOUNT"].fields_by_name[
        "pub_key"
    ]._serialized_options = b"\352\336\037\024public_key,omitempty\242\347\260*\npublic_key"
    _globals["_BASEACCOUNT"]._loaded_options = None
    _globals["_BASEACCOUNT"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\312\264-\034cosmos.auth.v1beta1.AccountI\212\347\260*\026cosmos-sdk/BaseAccount"
    )
    ...
    _globals["_MODULEACCOUNT"]._serialized_options = (
        b'\210\240\037\000\312\264-"cosmos.auth.v1beta1.ModuleAccountI\212\347\260*\030cosmos-sdk/ModuleAccount\222\347\260*\016module_account'
    )
