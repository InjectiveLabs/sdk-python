...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_PARAMETERCHANGEPROPOSAL"].fields_by_name[
        "changes"
    ]._serialized_options = b"\310\336\037\000\250\347\260*\001"
    _globals["_PARAMETERCHANGEPROPOSAL"]._loaded_options = None
    _globals["_PARAMETERCHANGEPROPOSAL"]._serialized_options = (
        b'\210\240\037\000\312\264-\032cosmos.gov.v1beta1.Content\212\347\260*"cosmos-sdk/ParameterChangeProposal'
    )
