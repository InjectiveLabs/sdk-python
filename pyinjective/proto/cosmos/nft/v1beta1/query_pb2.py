...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_QUERY"].methods_by_name[
        "Balance"
    ]._serialized_options = b"\202\323\344\223\0020\022./cosmos/nft/v1beta1/balance/{owner}/{class_id}"
    _globals["_QUERY"].methods_by_name["Owner"]._loaded_options = None
    _globals["_QUERY"].methods_by_name[
        "Owner"
    ]._serialized_options = b"\202\323\344\223\002+\022)/cosmos/nft/v1beta1/owner/{class_id}/{id}"
    _globals["_QUERY"].methods_by_name["Supply"]._loaded_options = None
    _globals["_QUERY"].methods_by_name[
        "Supply"
    ]._serialized_options = b"\202\323\344\223\002'\022%/cosmos/nft/v1beta1/supply/{class_id}"
    ...
    _globals["_QUERY"].methods_by_name[
        "NFT"
    ]._serialized_options = b"\202\323\344\223\002*\022(/cosmos/nft/v1beta1/nfts/{class_id}/{id}"
    _globals["_QUERY"].methods_by_name["Class"]._loaded_options = None
    _globals["_QUERY"].methods_by_name[
        "Class"
    ]._serialized_options = b"\202\323\344\223\002(\022&/cosmos/nft/v1beta1/classes/{class_id}"
    _globals["_QUERY"].methods_by_name["Classes"]._loaded_options = None
    _globals["_QUERY"].methods_by_name[
        "Classes"
    ]._serialized_options = b"\202\323\344\223\002\035\022\033/cosmos/nft/v1beta1/classes"
