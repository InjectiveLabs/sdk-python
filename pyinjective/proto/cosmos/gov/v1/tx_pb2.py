...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_MSGCANCELPROPOSALRESPONSE"].fields_by_name[
        "proposal_id"
    ]._serialized_options = b"\352\336\037\013proposal_id"
