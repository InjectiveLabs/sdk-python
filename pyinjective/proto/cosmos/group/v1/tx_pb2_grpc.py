...
def add_MsgServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("cosmos.group.v1.Msg", rpc_method_handlers)
...
class Msg(object):
    ...
    @staticmethod
    def UpdateGroupPolicyDecisionPolicy(
        request,
        target,
        options=(),
        channel_credentials=None,
