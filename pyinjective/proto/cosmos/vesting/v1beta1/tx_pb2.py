...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_MSGCREATEVESTINGACCOUNT"].fields_by_name[
        "from_address"
    ...
    _globals["_MSGCREATEVESTINGACCOUNT"]._serialized_options = (
        b'\350\240\037\001\202\347\260*\014from_address\212\347\260*"cosmos-sdk/MsgCreateVestingAccount'
    )
    _globals["_MSGCREATEPERMANENTLOCKEDACCOUNT"].fields_by_name["from_address"]._loaded_options = None
    _globals["_MSGCREATEPERMANENTLOCKEDACCOUNT"].fields_by_name[
        "from_address"
    ...
    _globals["_MSGCREATEPERMANENTLOCKEDACCOUNT"]._serialized_options = (
        b"\350\240\037\001\202\347\260*\014from_address\212\347\260*%cosmos-sdk/MsgCreatePermLockedAccount"
    )
    _globals["_MSGCREATEPERIODICVESTINGACCOUNT"].fields_by_name["vesting_periods"]._loaded_options = None
    _globals["_MSGCREATEPERIODICVESTINGACCOUNT"].fields_by_name[
        "vesting_periods"
    ]._serialized_options = b"\310\336\037\000\250\347\260*\001"
    _globals["_MSGCREATEPERIODICVESTINGACCOUNT"]._loaded_options = None
    _globals["_MSGCREATEPERIODICVESTINGACCOUNT"]._serialized_options = (
        b"\350\240\037\000\202\347\260*\014from_address\212\347\260*%cosmos-sdk/MsgCreatePeriodVestAccount"
    )
