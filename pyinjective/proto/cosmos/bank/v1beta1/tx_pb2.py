...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_MSGSEND"].fields_by_name[
        "amount"
    ...
    _globals["_MSGSEND"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\202\347\260*\014from_address\212\347\260*\022cosmos-sdk/MsgSend"
    )
    ...
    _globals["_MSGMULTISEND"]._serialized_options = (
        b"\350\240\037\000\202\347\260*\006inputs\212\347\260*\027cosmos-sdk/MsgMultiSend"
    )
