...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_MSGIBCSEND"].fields_by_name[
        "timeout_height"
    ]._serialized_options = b'\362\336\037\025yaml:"timeout_height"'
    _globals["_MSGIBCSEND"].fields_by_name["timeout_timestamp"]._loaded_options = None
    _globals["_MSGIBCSEND"].fields_by_name[
        "timeout_timestamp"
    ]._serialized_options = b'\362\336\037\030yaml:"timeout_timestamp"'
    _globals["_MSGIBCCLOSECHANNEL"].fields_by_name["channel"]._loaded_options = None
    _globals["_MSGIBCCLOSECHANNEL"].fields_by_name[
        "channel"
    ]._serialized_options = b'\362\336\037\025yaml:"source_channel"'
