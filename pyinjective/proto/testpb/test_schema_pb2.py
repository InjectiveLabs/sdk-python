...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_EXAMPLETABLE']._loaded_options = None
  ...
  _globals['_EXAMPLEAUTOINCREMENTTABLE']._loaded_options = None
