...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_GENESISSTATE'].fields_by_name['band_relayers']._loaded_options = None
  _globals['_GENESISSTATE'].fields_by_name['band_relayers']._serialized_options = b'\030\001'
  _globals['_GENESISSTATE'].fields_by_name['band_price_states']._loaded_options = None
  _globals['_GENESISSTATE'].fields_by_name['band_price_states']._serialized_options = b'\030\001'
  _globals['_GENESISSTATE'].fields_by_name['band_ibc_price_states']._loaded_options = None
  _globals['_GENESISSTATE'].fields_by_name['band_ibc_price_states']._serialized_options = b'\030\001'
  _globals['_GENESISSTATE'].fields_by_name['band_ibc_oracle_requests']._loaded_options = None
  _globals['_GENESISSTATE'].fields_by_name['band_ibc_oracle_requests']._serialized_options = b'\030\001'
  _globals['_GENESISSTATE'].fields_by_name['band_ibc_params']._loaded_options = None
  _globals['_GENESISSTATE'].fields_by_name['band_ibc_params']._serialized_options = b'\030\001\310\336\037\000'
  _globals['_GENESISSTATE'].fields_by_name['band_ibc_latest_client_id']._loaded_options = None
  _globals['_GENESISSTATE'].fields_by_name['band_ibc_latest_client_id']._serialized_options = b'\030\001'
  _globals['_GENESISSTATE'].fields_by_name['calldata_records']._loaded_options = None
  _globals['_GENESISSTATE'].fields_by_name['calldata_records']._serialized_options = b'\030\001'
  _globals['_GENESISSTATE'].fields_by_name['band_ibc_latest_request_id']._loaded_options = None
  _globals['_GENESISSTATE'].fields_by_name['band_ibc_latest_request_id']._serialized_options = b'\030\001'
  _globals['_GENESISSTATE'].fields_by_name['chainlink_price_states']._loaded_options = None
  _globals['_GENESISSTATE'].fields_by_name['chainlink_price_states']._serialized_options = b'\030\001'
  _globals['_GENESISSTATE']._serialized_start=130
  _globals['_GENESISSTATE']._serialized_end=1876
  _globals['_CALLDATARECORD']._serialized_start=1878
  _globals['_CALLDATARECORD']._serialized_end=1951
