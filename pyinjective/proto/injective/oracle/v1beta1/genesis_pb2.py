...
_GENESISSTATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pyth_price_states', full_name='injective.oracle.v1beta1.GenesisState.pyth_price_states', index=14,
...
_GENESISSTATE.fields_by_name['pyth_price_states'].message_type = injective_dot_oracle_dot_v1beta1_dot_oracle__pb2._PYTHPRICESTATE
