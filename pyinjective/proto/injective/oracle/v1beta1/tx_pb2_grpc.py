...
def add_MsgServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("injective.oracle.v1beta1.Msg", rpc_method_handlers)
