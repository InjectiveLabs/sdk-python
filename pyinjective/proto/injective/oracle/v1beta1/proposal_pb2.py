...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_GRANTBANDORACLEPRIVILEGEPROPOSAL"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\312\264-\032cosmos.gov.v1beta1.Content\212\347\260*'oracle/GrantBandOraclePrivilegeProposal"
    )
    _globals["_REVOKEBANDORACLEPRIVILEGEPROPOSAL"]._loaded_options = None
    _globals["_REVOKEBANDORACLEPRIVILEGEPROPOSAL"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\312\264-\032cosmos.gov.v1beta1.Content\212\347\260*(oracle/RevokeBandOraclePrivilegeProposal"
    )
    ...
    _globals["_GRANTPRICEFEEDERPRIVILEGEPROPOSAL"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\312\264-\032cosmos.gov.v1beta1.Content\212\347\260*(oracle/GrantPriceFeederPrivilegeProposal"
    )
    _globals["_GRANTPROVIDERPRIVILEGEPROPOSAL"]._loaded_options = None
    _globals["_GRANTPROVIDERPRIVILEGEPROPOSAL"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\312\264-\032cosmos.gov.v1beta1.Content\212\347\260*%oracle/GrantProviderPrivilegeProposal"
    )
    _globals["_REVOKEPROVIDERPRIVILEGEPROPOSAL"]._loaded_options = None
    _globals["_REVOKEPROVIDERPRIVILEGEPROPOSAL"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\312\264-\032cosmos.gov.v1beta1.Content\212\347\260*&oracle/RevokeProviderPrivilegeProposal"
    )
    _globals["_REVOKEPRICEFEEDERPRIVILEGEPROPOSAL"]._loaded_options = None
    _globals["_REVOKEPRICEFEEDERPRIVILEGEPROPOSAL"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\312\264-\032cosmos.gov.v1beta1.Content\212\347\260*)oracle/RevokePriceFeederPrivilegeProposal"
    )
    ...
    _globals["_AUTHORIZEBANDORACLEREQUESTPROPOSAL"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\312\264-\032cosmos.gov.v1beta1.Content\212\347\260*)oracle/AuthorizeBandOracleRequestProposal"
    )
    _globals["_UPDATEBANDORACLEREQUESTPROPOSAL"]._loaded_options = None
    _globals["_UPDATEBANDORACLEREQUESTPROPOSAL"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\312\264-\032cosmos.gov.v1beta1.Content\212\347\260*&oracle/UpdateBandOracleRequestProposal"
    )
    ...
    _globals["_ENABLEBANDIBCPROPOSAL"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\312\264-\032cosmos.gov.v1beta1.Content\212\347\260*\034oracle/EnableBandIBCProposal"
    )
    ...
    _globals["_REVOKESTORKPUBLISHERPRIVILEGEPROPOSAL"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\312\264-\032cosmos.gov.v1beta1.Content\212\347\260*,oracle/RevokeStorkPublisherPrivilegeProposal"
    )
