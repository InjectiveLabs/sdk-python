...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_MSGRELAYPROVIDERPRICES"].fields_by_name[
        "prices"
    ...
    _globals["_MSGRELAYPROVIDERPRICES"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\202\347\260*\006sender\212\347\260*\035oracle/MsgRelayProviderPrices"
    )
    _globals["_MSGRELAYPRICEFEEDPRICE"].fields_by_name["price"]._loaded_options = None
    _globals["_MSGRELAYPRICEFEEDPRICE"].fields_by_name[
        "price"
    ]._serialized_options = b"\310\336\037\000\332\336\037\033cosmossdk.io/math.LegacyDec"
    _globals["_MSGRELAYPRICEFEEDPRICE"]._loaded_options = None
    _globals["_MSGRELAYPRICEFEEDPRICE"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\202\347\260*\006sender\212\347\260*\035oracle/MsgRelayPriceFeedPrice"
    )
    _globals["_MSGRELAYBANDRATES"]._loaded_options = None
    _globals["_MSGRELAYBANDRATES"]._serialized_options = (
        b"\202\347\260*\007relayer\212\347\260*\030oracle/MsgRelayBandRates"
    )
    _globals["_MSGRELAYCOINBASEMESSAGES"]._loaded_options = None
    _globals["_MSGRELAYCOINBASEMESSAGES"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\202\347\260*\006sender\212\347\260*\037oracle/MsgRelayCoinbaseMessages"
    )
    ...
    _globals["_MSGREQUESTBANDIBCRATES"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\202\347\260*\006sender\212\347\260*\035oracle/MsgRequestBandIBCRates"
    )
    _globals["_MSGRELAYPYTHPRICES"]._loaded_options = None
    _globals["_MSGRELAYPYTHPRICES"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\202\347\260*\006sender\212\347\260*\031oracle/MsgRelayPythPrices"
    )
    ...
    _globals["_MSGUPDATEPARAMS"]._serialized_options = (
        b"\202\347\260*\tauthority\212\347\260*\026oracle/MsgUpdateParams"
    )
