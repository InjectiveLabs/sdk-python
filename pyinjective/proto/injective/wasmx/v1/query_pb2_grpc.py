...
from injective.wasmx.v1 import query_pb2 as injective_dot_wasmx_dot_v1_dot_query__pb2
...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in injective/wasmx/v1/query_pb2_grpc.py depends on'
