...
def add_MsgServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("injective.wasmx.v1.Msg", rpc_method_handlers)
...
class Msg(object):
    ...
    @staticmethod
    def UpdateRegistryContractParams(
        request,
        target,
        options=(),
    ...
    @staticmethod
    def DeactivateRegistryContract(
        request,
        target,
        options=(),
        channel_credentials=None,
