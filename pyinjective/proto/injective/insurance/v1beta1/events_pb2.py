...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _EVENTINSURANCEWITHDRAW.fields_by_name['withdrawal']._options = None
  _EVENTINSURANCEWITHDRAW.fields_by_name['withdrawal']._serialized_options = b'\310\336\037\000'
