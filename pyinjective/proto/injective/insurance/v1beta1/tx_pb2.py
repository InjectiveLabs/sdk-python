...
from pyinjective.proto.injective.insurance.v1beta1 import (
    insurance_pb2 as injective_dot_insurance_dot_v1beta1_dot_insurance__pb2,
)
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_MSGCREATEINSURANCEFUND"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\202\347\260*\006sender\212\347\260* insurance/MsgCreateInsuranceFund"
    )
    ...
    _globals["_MSGUNDERWRITE"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\202\347\260*\006sender\212\347\260*\027insurance/MsgUnderwrite"
    )
    ...
    _globals["_MSGREQUESTREDEMPTION"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\202\347\260*\006sender\212\347\260*\036insurance/MsgRequestRedemption"
    )
    ...
    _globals["_MSGUPDATEPARAMS"]._serialized_options = (
        b"\202\347\260*\tauthority\212\347\260*\031insurance/MsgUpdateParams"
    )
