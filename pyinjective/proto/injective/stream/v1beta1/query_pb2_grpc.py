...
from injective.stream.v1beta1 import query_pb2 as injective_dot_stream_dot_v1beta1_dot_query__pb2
...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in injective/stream/v1beta1/query_pb2_grpc.py depends on'
