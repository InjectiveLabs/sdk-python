...
class MsgStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ClaimVoucher = channel.unary_unary(
                '/injective.auction.v1beta1.Msg/ClaimVoucher',
                request_serializer=injective_dot_auction_dot_v1beta1_dot_tx__pb2.MsgClaimVoucher.SerializeToString,
                response_deserializer=injective_dot_auction_dot_v1beta1_dot_tx__pb2.MsgClaimVoucherResponse.FromString,
                _registered_method=True)
...
def add_MsgServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ClaimVoucher': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=injective_dot_auction_dot_v1beta1_dot_tx__pb2.MsgClaimVoucher.FromString,
                    response_serializer=injective_dot_auction_dot_v1beta1_dot_tx__pb2.MsgClaimVoucherResponse.SerializeToString,
            ),
    }
...
class Msg(object):
    ...
    def ClaimVoucher(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/injective.auction.v1beta1.Msg/ClaimVoucher',
            injective_dot_auction_dot_v1beta1_dot_tx__pb2.MsgClaimVoucher.SerializeToString,
            injective_dot_auction_dot_v1beta1_dot_tx__pb2.MsgClaimVoucherResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
