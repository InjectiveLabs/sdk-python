...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_CREATESPOTLIMITORDERAUTHZ"]._serialized_options = (
        b'\312\264-\rAuthorization\212\347\260*"exchange/CreateSpotLimitOrderAuthz'
    )
    _globals["_CREATESPOTMARKETORDERAUTHZ"]._loaded_options = None
    _globals["_CREATESPOTMARKETORDERAUTHZ"]._serialized_options = (
        b"\312\264-\rAuthorization\212\347\260*#exchange/CreateSpotMarketOrderAuthz"
    )
    _globals["_BATCHCREATESPOTLIMITORDERSAUTHZ"]._loaded_options = None
    _globals["_BATCHCREATESPOTLIMITORDERSAUTHZ"]._serialized_options = (
        b"\312\264-\rAuthorization\212\347\260*(exchange/BatchCreateSpotLimitOrdersAuthz"
    )
    _globals["_CANCELSPOTORDERAUTHZ"]._loaded_options = None
    _globals["_CANCELSPOTORDERAUTHZ"]._serialized_options = (
        b"\312\264-\rAuthorization\212\347\260*\035exchange/CancelSpotOrderAuthz"
    )
    _globals["_BATCHCANCELSPOTORDERSAUTHZ"]._loaded_options = None
    _globals["_BATCHCANCELSPOTORDERSAUTHZ"]._serialized_options = (
        b"\312\264-\rAuthorization\212\347\260*#exchange/BatchCancelSpotOrdersAuthz"
    )
    _globals["_CREATEDERIVATIVELIMITORDERAUTHZ"]._loaded_options = None
    _globals["_CREATEDERIVATIVELIMITORDERAUTHZ"]._serialized_options = (
        b"\312\264-\rAuthorization\212\347\260*(exchange/CreateDerivativeLimitOrderAuthz"
    )
    _globals["_CREATEDERIVATIVEMARKETORDERAUTHZ"]._loaded_options = None
    _globals["_CREATEDERIVATIVEMARKETORDERAUTHZ"]._serialized_options = (
        b"\312\264-\rAuthorization\212\347\260*)exchange/CreateDerivativeMarketOrderAuthz"
    )
    _globals["_BATCHCREATEDERIVATIVELIMITORDERSAUTHZ"]._loaded_options = None
    _globals["_BATCHCREATEDERIVATIVELIMITORDERSAUTHZ"]._serialized_options = (
        b"\312\264-\rAuthorization\212\347\260*.exchange/BatchCreateDerivativeLimitOrdersAuthz"
    )
    _globals["_CANCELDERIVATIVEORDERAUTHZ"]._loaded_options = None
    _globals["_CANCELDERIVATIVEORDERAUTHZ"]._serialized_options = (
        b"\312\264-\rAuthorization\212\347\260*#exchange/CancelDerivativeOrderAuthz"
    )
    _globals["_BATCHCANCELDERIVATIVEORDERSAUTHZ"]._loaded_options = None
    _globals["_BATCHCANCELDERIVATIVEORDERSAUTHZ"]._serialized_options = (
        b"\312\264-\rAuthorization\212\347\260*)exchange/BatchCancelDerivativeOrdersAuthz"
    )
    _globals["_BATCHUPDATEORDERSAUTHZ"]._loaded_options = None
    _globals["_BATCHUPDATEORDERSAUTHZ"]._serialized_options = (
        b"\312\264-\rAuthorization\212\347\260*\037exchange/BatchUpdateOrdersAuthz"
    )
