...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CREATESPOTLIMITORDERAUTHZ._serialized_options = b'\322\264-\rAuthorization'
  _CREATESPOTMARKETORDERAUTHZ._options = None
  _CREATESPOTMARKETORDERAUTHZ._serialized_options = b'\322\264-\rAuthorization'
  _BATCHCREATESPOTLIMITORDERSAUTHZ._options = None
  _BATCHCREATESPOTLIMITORDERSAUTHZ._serialized_options = b'\322\264-\rAuthorization'
  _CANCELSPOTORDERAUTHZ._options = None
  _CANCELSPOTORDERAUTHZ._serialized_options = b'\322\264-\rAuthorization'
  _BATCHCANCELSPOTORDERSAUTHZ._options = None
  _BATCHCANCELSPOTORDERSAUTHZ._serialized_options = b'\322\264-\rAuthorization'
  _CREATEDERIVATIVELIMITORDERAUTHZ._options = None
  _CREATEDERIVATIVELIMITORDERAUTHZ._serialized_options = b'\322\264-\rAuthorization'
  _CREATEDERIVATIVEMARKETORDERAUTHZ._options = None
  _CREATEDERIVATIVEMARKETORDERAUTHZ._serialized_options = b'\322\264-\rAuthorization'
  _BATCHCREATEDERIVATIVELIMITORDERSAUTHZ._options = None
  _BATCHCREATEDERIVATIVELIMITORDERSAUTHZ._serialized_options = b'\322\264-\rAuthorization'
  _CANCELDERIVATIVEORDERAUTHZ._options = None
  _CANCELDERIVATIVEORDERAUTHZ._serialized_options = b'\322\264-\rAuthorization'
  _BATCHCANCELDERIVATIVEORDERSAUTHZ._options = None
  _BATCHCANCELDERIVATIVEORDERSAUTHZ._serialized_options = b'\322\264-\rAuthorization'
  _BATCHUPDATEORDERSAUTHZ._options = None
  _BATCHUPDATEORDERSAUTHZ._serialized_options = b'\322\264-\rAuthorization'
