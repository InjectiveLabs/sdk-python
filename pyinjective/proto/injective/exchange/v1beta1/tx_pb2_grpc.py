...
def add_MsgServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("injective.exchange.v1beta1.Msg", rpc_method_handlers)
...
class Msg(object):
    ...
    @staticmethod
    def InstantPerpetualMarketLaunch(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def InstantExpiryFuturesMarketLaunch(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def BatchCreateSpotLimitOrders(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def CreateDerivativeLimitOrder(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def BatchCreateDerivativeLimitOrders(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def CreateDerivativeMarketOrder(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def BatchCancelDerivativeOrders(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def InstantBinaryOptionsMarketLaunch(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def CreateBinaryOptionsLimitOrder(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def CreateBinaryOptionsMarketOrder(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def BatchCancelBinaryOptionsOrders(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def AdminUpdateBinaryOptionsMarket(
        request,
        target,
        options=(),
        channel_credentials=None,
