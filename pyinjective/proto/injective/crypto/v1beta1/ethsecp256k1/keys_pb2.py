...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='injective/crypto/v1beta1/ethsecp256k1/keys.proto',
  package='injective.crypto.v1beta1.ethsecp256k1',
  syntax='proto3',
  serialized_options=b'ZKgithub.com/InjectiveLabs/injective-core/injective-chain/crypto/ethsecp256k1',
...
_PUBKEY = _descriptor.Descriptor(
  name='PubKey',
  full_name='injective.crypto.v1beta1.ethsecp256k1.PubKey',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='injective.crypto.v1beta1.ethsecp256k1.PubKey.key', index=0,
...
_PRIVKEY = _descriptor.Descriptor(
  name='PrivKey',
  full_name='injective.crypto.v1beta1.ethsecp256k1.PrivKey',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='injective.crypto.v1beta1.ethsecp256k1.PrivKey.key', index=0,
      number=1, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=b"",
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
PubKey = _reflection.GeneratedProtocolMessageType('PubKey', (_message.Message,), {
  'DESCRIPTOR' : _PUBKEY,
  '__module__' : 'injective.crypto.v1beta1.ethsecp256k1.keys_pb2'
