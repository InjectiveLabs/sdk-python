...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_QUERY"].methods_by_name[
        "Params"
    ]._serialized_options = b"\202\323\344\223\002\037\022\035/chainlink/ocr/v1beta1/params"
    _globals["_QUERY"].methods_by_name["FeedConfig"]._loaded_options = None
    _globals["_QUERY"].methods_by_name[
        "FeedConfig"
    ]._serialized_options = b"\202\323\344\223\002.\022,/chainlink/ocr/v1beta1/feed_config/{feed_id}"
    _globals["_QUERY"].methods_by_name["FeedConfigInfo"]._loaded_options = None
    _globals["_QUERY"].methods_by_name[
        "FeedConfigInfo"
    ]._serialized_options = b"\202\323\344\223\0023\0221/chainlink/ocr/v1beta1/feed_config_info/{feed_id}"
    _globals["_QUERY"].methods_by_name["LatestRound"]._loaded_options = None
    _globals["_QUERY"].methods_by_name[
        "LatestRound"
    ]._serialized_options = b"\202\323\344\223\002/\022-/chainlink/ocr/v1beta1/latest_round/{feed_id}"
    _globals["_QUERY"].methods_by_name["LatestTransmissionDetails"]._loaded_options = None
    _globals["_QUERY"].methods_by_name[
        "LatestTransmissionDetails"
    ]._serialized_options = b"\202\323\344\223\002>\022</chainlink/ocr/v1beta1/latest_transmission_details/{feed_id}"
    _globals["_QUERY"].methods_by_name["OwedAmount"]._loaded_options = None
    _globals["_QUERY"].methods_by_name[
        "OwedAmount"
    ]._serialized_options = b"\202\323\344\223\0022\0220/chainlink/ocr/v1beta1/owed_amount/{transmitter}"
    _globals["_QUERY"].methods_by_name["OcrModuleState"]._loaded_options = None
    _globals["_QUERY"].methods_by_name[
        "OcrModuleState"
    ]._serialized_options = b"\202\323\344\223\002%\022#/chainlink/ocr/v1beta1/module_state"
