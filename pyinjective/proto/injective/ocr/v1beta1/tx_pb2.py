...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_MSGCREATEFEED"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\202\347\260*\006sender\212\347\260*\021ocr/MsgCreateFeed"
    )
    _globals["_MSGUPDATEFEED"].fields_by_name["link_per_observation"]._loaded_options = None
    _globals["_MSGUPDATEFEED"].fields_by_name[
        "link_per_observation"
    ]._serialized_options = b"\310\336\037\001\332\336\037\025cosmossdk.io/math.Int"
    ...
    _globals["_MSGUPDATEFEED"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\202\347\260*\006sender\212\347\260*\021ocr/MsgUpdateFeed"
    )
    _globals["_MSGTRANSMIT"]._loaded_options = None
    _globals["_MSGTRANSMIT"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\202\347\260*\013transmitter\212\347\260*\017ocr/MsgTransmit"
    )
    ...
    _globals["_MSGFUNDFEEDREWARDPOOL"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\202\347\260*\006sender\212\347\260*\031ocr/MsgFundFeedRewardPool"
    )
    ...
    _globals["_MSGWITHDRAWFEEDREWARDPOOL"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\202\347\260*\006sender\212\347\260*\035ocr/MsgWithdrawFeedRewardPool"
    )
    _globals["_MSGSETPAYEES"]._loaded_options = None
    _globals["_MSGSETPAYEES"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\202\347\260*\006sender\212\347\260*\020ocr/MsgSetPayees"
    )
    _globals["_MSGTRANSFERPAYEESHIP"]._loaded_options = None
    _globals["_MSGTRANSFERPAYEESHIP"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\202\347\260*\006sender\212\347\260*\030ocr/MsgTransferPayeeship"
    )
    _globals["_MSGACCEPTPAYEESHIP"]._loaded_options = None
    _globals["_MSGACCEPTPAYEESHIP"]._serialized_options = (
        b"\210\240\037\000\350\240\037\000\202\347\260*\013transmitter\212\347\260*\026ocr/MsgAcceptPayeeship"
    )
