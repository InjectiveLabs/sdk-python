...
from pyinjective.proto.injective.tokenfactory.v1beta1 import (
    tx_pb2 as injective_dot_tokenfactory_dot_v1beta1_dot_tx__pb2,
)
...
def add_MsgServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("injective.tokenfactory.v1beta1.Msg", rpc_method_handlers)
