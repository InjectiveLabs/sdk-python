...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _MSGCREATENAMESPACE.fields_by_name['sender']._options = None
  _MSGCREATENAMESPACE.fields_by_name['sender']._serialized_options = b'\362\336\037\ryaml:\"sender\"'
  _MSGCREATENAMESPACE.fields_by_name['namespace']._options = None
  _MSGCREATENAMESPACE.fields_by_name['namespace']._serialized_options = b'\310\336\037\000'
  _MSGCREATENAMESPACE._options = None
  _MSGCREATENAMESPACE._serialized_options = b'\202\347\260*\006sender'
  _MSGDELETENAMESPACE.fields_by_name['sender']._options = None
  _MSGDELETENAMESPACE.fields_by_name['sender']._serialized_options = b'\362\336\037\ryaml:\"sender\"'
  _MSGDELETENAMESPACE._options = None
  _MSGDELETENAMESPACE._serialized_options = b'\202\347\260*\006sender'
  _MSGUPDATENAMESPACE.fields_by_name['sender']._options = None
  _MSGUPDATENAMESPACE.fields_by_name['sender']._serialized_options = b'\362\336\037\ryaml:\"sender\"'
  _MSGUPDATENAMESPACE._options = None
  _MSGUPDATENAMESPACE._serialized_options = b'\202\347\260*\006sender'
  _MSGUPDATENAMESPACEROLES_ROLEPERMISSIONSENTRY._options = None
  _MSGUPDATENAMESPACEROLES_ROLEPERMISSIONSENTRY._serialized_options = b'8\001'
  _MSGUPDATENAMESPACEROLES_ADDRESSROLESENTRY._options = None
  _MSGUPDATENAMESPACEROLES_ADDRESSROLESENTRY._serialized_options = b'8\001'
  _MSGUPDATENAMESPACEROLES.fields_by_name['sender']._options = None
  _MSGUPDATENAMESPACEROLES.fields_by_name['sender']._serialized_options = b'\362\336\037\ryaml:\"sender\"'
  _MSGUPDATENAMESPACEROLES._options = None
  _MSGUPDATENAMESPACEROLES._serialized_options = b'\202\347\260*\006sender'
  _MSGREVOKENAMESPACEROLES_ADDRESSROLESTOREVOKEENTRY._options = None
  _MSGREVOKENAMESPACEROLES_ADDRESSROLESTOREVOKEENTRY._serialized_options = b'8\001'
  _MSGREVOKENAMESPACEROLES.fields_by_name['sender']._options = None
  _MSGREVOKENAMESPACEROLES.fields_by_name['sender']._serialized_options = b'\362\336\037\ryaml:\"sender\"'
  _MSGREVOKENAMESPACEROLES._options = None
  _MSGREVOKENAMESPACEROLES._serialized_options = b'\202\347\260*\006sender'
  _MSGCLAIMVOUCHER.fields_by_name['sender']._options = None
  _MSGCLAIMVOUCHER.fields_by_name['sender']._serialized_options = b'\362\336\037\ryaml:\"sender\"'
  _MSGCLAIMVOUCHER._options = None
  _MSGCLAIMVOUCHER._serialized_options = b'\202\347\260*\006sender'
  ...
  _globals['_MSGUPDATENAMESPACEROLES']._serialized_end=1853
  _globals['_MSGUPDATENAMESPACEROLES_ROLEPERMISSIONSENTRY']._serialized_start=1695
  _globals['_MSGUPDATENAMESPACEROLES_ROLEPERMISSIONSENTRY']._serialized_end=1749
  _globals['_MSGUPDATENAMESPACEROLES_ADDRESSROLESENTRY']._serialized_start=1751
  _globals['_MSGUPDATENAMESPACEROLES_ADDRESSROLESENTRY']._serialized_end=1840
  _globals['_MSGUPDATENAMESPACEROLESRESPONSE']._serialized_start=1855
  _globals['_MSGUPDATENAMESPACEROLESRESPONSE']._serialized_end=1888
  _globals['_MSGREVOKENAMESPACEROLES']._serialized_start=1891
  _globals['_MSGREVOKENAMESPACEROLES']._serialized_end=2203
  _globals['_MSGREVOKENAMESPACEROLES_ADDRESSROLESTOREVOKEENTRY']._serialized_start=2093
  _globals['_MSGREVOKENAMESPACEROLES_ADDRESSROLESTOREVOKEENTRY']._serialized_end=2190
  _globals['_MSGREVOKENAMESPACEROLESRESPONSE']._serialized_start=2205
  _globals['_MSGREVOKENAMESPACEROLESRESPONSE']._serialized_end=2238
  _globals['_MSGCLAIMVOUCHER']._serialized_start=2240
  _globals['_MSGCLAIMVOUCHER']._serialized_end=2325
  _globals['_MSGCLAIMVOUCHERRESPONSE']._serialized_start=2327
  _globals['_MSGCLAIMVOUCHERRESPONSE']._serialized_end=2352
  _globals['_MSG']._serialized_start=2355
  _globals['_MSG']._serialized_end=3277
