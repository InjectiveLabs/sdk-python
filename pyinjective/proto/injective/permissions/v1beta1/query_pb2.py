...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _QUERYVOUCHERSFORADDRESSRESPONSE_VOUCHERSENTRY._options = None
  _QUERYVOUCHERSFORADDRESSRESPONSE_VOUCHERSENTRY._serialized_options = b'8\001'
  _QUERY.methods_by_name['Params']._options = None
  _QUERY.methods_by_name['Params']._serialized_options = b'\202\323\344\223\002\'\022%/injective/permissions/v1beta1/params'
  _QUERY.methods_by_name['AllNamespaces']._options = None
  _QUERY.methods_by_name['AllNamespaces']._serialized_options = b'\202\323\344\223\002/\022-/injective/permissions/v1beta1/all_namespaces'
  _QUERY.methods_by_name['NamespaceByDenom']._options = None
  _QUERY.methods_by_name['NamespaceByDenom']._serialized_options = b'\202\323\344\223\0023\0221/injective/permissions/v1beta1/namespace_by_denom'
  _QUERY.methods_by_name['AddressRoles']._options = None
  _QUERY.methods_by_name['AddressRoles']._serialized_options = b'\202\323\344\223\0022\0220/injective/permissions/v1beta1/addresses_by_role'
  _QUERY.methods_by_name['AddressesByRole']._options = None
  _QUERY.methods_by_name['AddressesByRole']._serialized_options = b'\202\323\344\223\0022\0220/injective/permissions/v1beta1/addresses_by_role'
  _QUERY.methods_by_name['VouchersForAddress']._options = None
  _QUERY.methods_by_name['VouchersForAddress']._serialized_options = b'\202\323\344\223\0025\0223/injective/permissions/v1beta1/vouchers_for_address'
  ...
  _globals['_QUERYVOUCHERSFORADDRESSRESPONSE']._serialized_start=968
  _globals['_QUERYVOUCHERSFORADDRESSRESPONSE']._serialized_end=1186
  _globals['_QUERYVOUCHERSFORADDRESSRESPONSE_VOUCHERSENTRY']._serialized_start=1099
  _globals['_QUERYVOUCHERSFORADDRESSRESPONSE_VOUCHERSENTRY']._serialized_end=1186
  _globals['_QUERY']._serialized_start=1189
  _globals['_QUERY']._serialized_end=2350
