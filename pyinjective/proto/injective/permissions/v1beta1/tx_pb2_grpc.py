...
from injective.permissions.v1beta1 import tx_pb2 as injective_dot_permissions_dot_v1beta1_dot_tx__pb2
...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in injective/permissions/v1beta1/tx_pb2_grpc.py depends on'
