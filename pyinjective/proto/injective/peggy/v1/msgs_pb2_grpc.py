...
def add_MsgServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("injective.peggy.v1.Msg", rpc_method_handlers)
...
class Msg(object):
    ...
    @staticmethod
    def SubmitBadSignatureEvidence(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def BlacklistEthereumAddresses(
        request,
        target,
        options=(),
        channel_credentials=None,
