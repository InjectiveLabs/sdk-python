...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PARAMS'].fields_by_name['slash_fraction_valset']._serialized_options = b'\030\001\310\336\037\000\332\336\037\033cosmossdk.io/math.LegacyDec'
  _globals['_PARAMS'].fields_by_name['slash_fraction_batch']._loaded_options = None
  _globals['_PARAMS'].fields_by_name['slash_fraction_batch']._serialized_options = b'\030\001\310\336\037\000\332\336\037\033cosmossdk.io/math.LegacyDec'
  _globals['_PARAMS'].fields_by_name['slash_fraction_claim']._loaded_options = None
  _globals['_PARAMS'].fields_by_name['slash_fraction_claim']._serialized_options = b'\030\001\310\336\037\000\332\336\037\033cosmossdk.io/math.LegacyDec'
  _globals['_PARAMS'].fields_by_name['slash_fraction_conflicting_claim']._loaded_options = None
  _globals['_PARAMS'].fields_by_name['slash_fraction_conflicting_claim']._serialized_options = b'\030\001\310\336\037\000\332\336\037\033cosmossdk.io/math.LegacyDec'
  _globals['_PARAMS'].fields_by_name['slash_fraction_bad_eth_signature']._loaded_options = None
  _globals['_PARAMS'].fields_by_name['slash_fraction_bad_eth_signature']._serialized_options = b'\030\001\310\336\037\000\332\336\037\033cosmossdk.io/math.LegacyDec'
  _globals['_PARAMS'].fields_by_name['claim_slashing_enabled']._loaded_options = None
  _globals['_PARAMS'].fields_by_name['claim_slashing_enabled']._serialized_options = b'\030\001'
  ...
  _globals['_PARAMS']._serialized_end=1589
