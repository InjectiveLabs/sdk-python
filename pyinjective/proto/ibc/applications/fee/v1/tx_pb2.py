...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_MSGREGISTERPAYEE"]._serialized_options = (
        b"\210\240\037\000\202\347\260*\007relayer\212\347\260*\033cosmos-sdk/MsgRegisterPayee"
    )
    _globals["_MSGREGISTERCOUNTERPARTYPAYEE"]._loaded_options = None
    _globals["_MSGREGISTERCOUNTERPARTYPAYEE"]._serialized_options = (
        b"\210\240\037\000\202\347\260*\007relayer\212\347\260*'cosmos-sdk/MsgRegisterCounterpartyPayee"
    )
    ...
    _globals["_MSGPAYPACKETFEE"]._serialized_options = (
        b"\210\240\037\000\202\347\260*\006signer\212\347\260*\032cosmos-sdk/MsgPayPacketFee"
    )
    _globals["_MSGPAYPACKETFEEASYNC"].fields_by_name["packet_id"]._loaded_options = None
    _globals["_MSGPAYPACKETFEEASYNC"].fields_by_name[
        "packet_id"
    ...
    _globals["_MSGPAYPACKETFEEASYNC"]._serialized_options = (
        b"\210\240\037\000\202\347\260*\npacket_fee\212\347\260*\037cosmos-sdk/MsgPayPacketFeeAsync"
    )
