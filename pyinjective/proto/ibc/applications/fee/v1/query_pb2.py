...
from pyinjective.proto.ibc.applications.fee.v1 import (
    genesis_pb2 as ibc_dot_applications_dot_fee_dot_v1_dot_genesis__pb2,
)
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_QUERYINCENTIVIZEDPACKETSRESPONSE"].fields_by_name[
    ...
    _globals["_QUERYINCENTIVIZEDPACKETRESPONSE"].fields_by_name[
        "incentivized_packet"
    ]._serialized_options = b"\310\336\037\000"
    ...
    _globals["_QUERYTOTALRECVFEESRESPONSE"].fields_by_name[
        "recv_fees"
    ...
    _globals["_QUERYTOTALACKFEESRESPONSE"].fields_by_name[
        "ack_fees"
    ]._serialized_options = b"\310\336\037\000\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins"
    ...
    _globals["_QUERYFEEENABLEDCHANNELSRESPONSE"].fields_by_name[
        "fee_enabled_channels"
    ]._serialized_options = b"\310\336\037\000"
    _globals["_QUERY"].methods_by_name["IncentivizedPackets"]._loaded_options = None
    _globals["_QUERY"].methods_by_name[
        "IncentivizedPackets"
    ]._serialized_options = b"\202\323\344\223\002'\022%/ibc/apps/fee/v1/incentivized_packets"
    _globals["_QUERY"].methods_by_name["IncentivizedPacket"]._loaded_options = None
    _globals["_QUERY"].methods_by_name[
        "IncentivizedPacket"
    ]._serialized_options = b"\202\323\344\223\002\177\022}/ibc/apps/fee/v1/channels/{packet_id.channel_id}/ports/{packet_id.port_id}/sequences/{packet_id.sequence}/incentivized_packet"
    _globals["_QUERY"].methods_by_name["IncentivizedPacketsForChannel"]._loaded_options = None
    _globals["_QUERY"].methods_by_name[
        "IncentivizedPacketsForChannel"
    ]._serialized_options = (
        b"\202\323\344\223\002M\022K/ibc/apps/fee/v1/channels/{channel_id}/ports/{port_id}/incentivized_packets"
    )
    _globals["_QUERY"].methods_by_name["TotalRecvFees"]._loaded_options = None
    _globals["_QUERY"].methods_by_name[
        "TotalRecvFees"
    ]._serialized_options = b"\202\323\344\223\002{\022y/ibc/apps/fee/v1/channels/{packet_id.channel_id}/ports/{packet_id.port_id}/sequences/{packet_id.sequence}/total_recv_fees"
    _globals["_QUERY"].methods_by_name["TotalAckFees"]._loaded_options = None
    _globals["_QUERY"].methods_by_name[
        "TotalAckFees"
    ]._serialized_options = b"\202\323\344\223\002z\022x/ibc/apps/fee/v1/channels/{packet_id.channel_id}/ports/{packet_id.port_id}/sequences/{packet_id.sequence}/total_ack_fees"
    _globals["_QUERY"].methods_by_name["TotalTimeoutFees"]._loaded_options = None
    _globals["_QUERY"].methods_by_name[
        "TotalTimeoutFees"
    ]._serialized_options = b"\202\323\344\223\002~\022|/ibc/apps/fee/v1/channels/{packet_id.channel_id}/ports/{packet_id.port_id}/sequences/{packet_id.sequence}/total_timeout_fees"
    _globals["_QUERY"].methods_by_name["Payee"]._loaded_options = None
    _globals["_QUERY"].methods_by_name[
        "Payee"
    ]._serialized_options = b"\202\323\344\223\002A\022?/ibc/apps/fee/v1/channels/{channel_id}/relayers/{relayer}/payee"
    _globals["_QUERY"].methods_by_name["CounterpartyPayee"]._loaded_options = None
    _globals["_QUERY"].methods_by_name[
        "CounterpartyPayee"
    ]._serialized_options = (
        b"\202\323\344\223\002N\022L/ibc/apps/fee/v1/channels/{channel_id}/relayers/{relayer}/counterparty_payee"
    )
    _globals["_QUERY"].methods_by_name["FeeEnabledChannels"]._loaded_options = None
    _globals["_QUERY"].methods_by_name[
        "FeeEnabledChannels"
    ]._serialized_options = b"\202\323\344\223\002\036\022\034/ibc/apps/fee/v1/fee_enabled"
    _globals["_QUERY"].methods_by_name["FeeEnabledChannel"]._loaded_options = None
    _globals["_QUERY"].methods_by_name[
        "FeeEnabledChannel"
    ]._serialized_options = (
        b"\202\323\344\223\002D\022B/ibc/apps/fee/v1/channels/{channel_id}/ports/{port_id}/fee_enabled"
    )
