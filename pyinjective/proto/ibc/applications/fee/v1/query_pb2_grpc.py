...
class Query(object):
    ...
    @staticmethod
    def IncentivizedPacketsForChannel(
        request,
        target,
        options=(),
        channel_credentials=None,
