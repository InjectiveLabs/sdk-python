...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _MSGCHANNELOPENTRYRESPONSE.fields_by_name['channel_id']._options = None
  _MSGCHANNELOPENTRYRESPONSE.fields_by_name['channel_id']._serialized_options = b'\362\336\037\021yaml:\"channel_id\"'
