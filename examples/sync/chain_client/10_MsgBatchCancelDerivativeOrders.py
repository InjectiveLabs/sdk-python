...
async def main() -> None:
    ...
    orders = [
        composer.OrderData(
            ...
            order_hash="0xcb4247f408f31e24b348e7c955154a56045b527f6f08de995460a545b57820b3"
        ),
        composer.OrderData(
            market_id=market_id,
            subaccount_id=subaccount_id,
            order_hash="0x1b838dc9ca690223c052095294795d6a122a8a840ab456acab06c7fc957a4a60"
        )
    ]
