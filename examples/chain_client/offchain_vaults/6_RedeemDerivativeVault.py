...
async def main() -> None:
    ...
    # this contract is derivative offchain vault for INJ/USDT PERP on testnet
    contract_address = "inj1v4s3v3nmsx6szyxqgcnqdfseucu4ccm65sh0xr"
    msg = composer.MsgPrivilegedExecuteContract(
        ...
        """ % (subaccount_id, address.to_acc_bech32()),
        funds='1000000000000000factory/%s/lp' % contract_address,
    )
    ...
    if resp == None:
        ...
        return
    print('derivative vault LP redeemed')
