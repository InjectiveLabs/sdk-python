...
class Transaction:
    ...
    def msg_create_spot_market_order(self, subaccount_id: str,  market_id: str, fee_recipient: str, price, quantity, order_type, trigger_price) -> None:
        msg = {
...
async def main() -> None:
    ...
    tx.msg_create_spot_market_order(
        market_id = market,
